...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment addComment(CommentRequestDto commentRequestDto) {
        Boolean isUserExist = webClientBuilder.build().get()
                .uri("http://USERSERVICE/api/user/users/isExist/{userId}", commentRequestDto.getUserId())
                .retrieve()
                .bodyToMono(Boolean.class)
                .block();
        ...
        if (isUserExist) {
            ...
            Comment comment = Comment.builder()
                    ...
                    .commentByUserId(commentRequestDto.getUserId())
                    .movie(movie)
                    .build();
